...
function Login() {
    ...
    return (
        ...
        <section className="bg-gray-50 dark:bg-gray-900">
            <Link href={"/"} type="button" className="flex items-center justify-center px-4 py-2 text-md font-medium dark:text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800 mt-5">
            ...
            <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <a href="#" className="flex  items-center mb-6 text-2xl font-semibold text-red-900 dark:text-red-900">
                    {error}
                </a>
